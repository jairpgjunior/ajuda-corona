              ...
              <div className="card2-0-0">
                  <div className="card2-r1">
                      ...
                      <div className="card2-0-0-0-1">
                          ...
                          <div className="card2-rectangle_1">
                              <div className="card2-0-0-0-1-1-0">
                                  <div className="card2-0-0-0-1-1-0-0" /> 
                                  <img src={this.props.img_src} className="card2-image-9" /> 
                                  <div className="card2-0-0-0-1-1-0-2" /> 
                              </div>
                              <div className="card2-0-0-0-1-1-1">
                                  <div className="card2-0-0-0-1-1-1-0" /> 
                                  <div className="card2-fazer_compras_-3">
                                      { this.props.text }
                                  </div>
                                  <div className="card2-0-0-0-1-1-1-2" /> 
                              </div>
                          </div>
                  ...
                  <div className="card2-1-0-0">
                      <div className="card2-r19">
                          ...
                          <div className="card2-1-0-0-0-1">
                              ...
                              <div className="card2-rectangle_9">
                                  <div className="card2-1-0-0-0-1-1-0">
                                      <div className="card2-1-0-0-0-1-1-0-0" /> 
                                      <img src={this.props.img_src} className="card2-image-2" /> 
                                      <div className="card2-1-0-0-0-1-1-0-2" /> 
                                  </div>
                                  <div className="card2-1-0-0-0-1-1-1">
                                      <div className="card2-1-0-0-0-1-1-1-0" /> 
                                      <div className="card2-fazer_compras_-6">
                                          { this.props.text }
                                      </div>
                                      <div className="card2-1-0-0-0-1-1-1-2" /> 
                                  </div>
                              </div>
